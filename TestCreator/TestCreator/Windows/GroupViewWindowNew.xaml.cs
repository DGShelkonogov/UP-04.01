...
{
    public partial class GroupViewWindowNew : Window
    {
        ...
        public void init(UserGroup userGroup)
        {
            ...
            foreach (var test in userGroup.group.tests)
            {
                tests.Add(test);
            }
        ...
        private void listSubscribers_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                var user = listSubscribers.SelectedItem as User;
                var window = new MyProfileWindow();
        ...
        {
            var window = new ChooseTestWindow();
